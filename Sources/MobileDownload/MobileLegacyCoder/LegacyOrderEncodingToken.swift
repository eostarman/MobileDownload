...
// case ShelfCount = "^" // mpr: obsolete - but the c# decoder has a bug: so we need to emit 999999
...
// VAT = " " // TODO FIGURE OUT TOKEN - mpr: using ",VAT"
// Levy = " ' // TODO FIGURE OUT TOKEN - mpr: using ",Levy"

public enum LegacyOrderEncodingToken: String, LegacyEncodingToken { // aka 'eToken.cs'
    
    case obsolete_BuildTo = "U" // mpr: obsolete - transmit NO_BUILDTO (defined in OrderCreator.cs as -999_999)
    case obsolete_Count = "V" // mpr: obsolete - transmit NO_COUNT
    case obsolete_RouteBookBuildTo = "{" // mpr: obsolete - but the c# decoder has a bug: so we need to emit 999999 = NO_ROUTEBOOKBUILDTO
    ...
    case TransactionCurrencyNid = ",Currency"
    case VAT = ",VAT"
    case Levy = ",Levy"
}
